      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="p-12 border border-black/10 rounded-sm hover:border-orange-500 transition-colors group">
            <h3 className="text-2xl font-bold mb-6 group-hover:text-orange-500 transition-colors">Strategic Approach</h3>
          ...
          <div className="p-12 border border-black/10 rounded-sm hover:border-orange-500 transition-colors group">
            <h3 className="text-2xl font-bold mb-6 group-hover:text-orange-500 transition-colors">Creative Excellence</h3>
            <p className="text-black/60 leading-relaxed">
              Our team of award-winning designers and creative thinkers push the boundaries of what's possible in digital design.
            </p>
          </div>
          <div className="p-12 border border-black/10 rounded-sm hover:border-orange-500 transition-colors group">
            <h3 className="text-2xl font-bold mb-6 group-hover:text-orange-500 transition-colors">Data-Driven Results</h3>
            <p className="text-black/60 leading-relaxed">
              We use advanced analytics and user testing to ensure our solutions deliver measurable growth and ROI for your brand.
            </p>
          </div>
          <div className="p-12 border border-black/10 rounded-sm hover:border-orange-500 transition-colors group">
            <h3 className="text-2xl font-bold mb-6 group-hover:text-orange-500 transition-colors">Agile Methodology</h3>
            <p className="text-black/60 leading-relaxed">
